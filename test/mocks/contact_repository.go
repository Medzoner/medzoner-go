...
//
//	mockgen -destination=../../../test/mocks/contact_repository.go -package=mocks -source=./contact_repository.go
//
...
func (mr *MockContactRepositoryMockRecorder) Save(ctx, contact any) *gomock.Call {
